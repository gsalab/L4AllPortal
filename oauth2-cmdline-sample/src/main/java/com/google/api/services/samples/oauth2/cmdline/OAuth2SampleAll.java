...
public class OAuth2SampleAll {
  ...
  private static Credential authorize() throws Exception {
    ...
    clientSecrets = GoogleClientSecrets.load(JSON_FACTORY,
        new InputStreamReader(OAuth2SampleAll.class.getResourceAsStream("/client_secrets.json")));
  ...
  public static void main(String[] args) {
   ...
   // create the service and pass it the credentials you created earlier
     ...
     SpreadsheetEntry spreadsheet = spreadsheets.get(0);
      ...
      WorksheetEntry allegati = worksheetsf.get(ID_FOGLIO_ALLEGATI);
       ...
       try{
         ...
         for(int lav=2; lav<tagsallegati.length; lav++){
           ...
           if(ExpId!=null) {           
             ...
             allegatidto.add(str_allegatodto);
          } 
      ...
      for(int i:FOGLIO_WIDGET_COLONNE_IDWIDGETS) {
        ...
        for(int k=2; k<le.size();k++) {
          ...
          if(w!=null) {
            ...
            //Per capire il layout del facet prendo il foglio corrispondente al define del widget 
            ...
            //Per avvalorare i dati del facet prendo il foglio corrispondente ai dati 
      ...
      */
      //System.out.println(widgets_id.toString());
