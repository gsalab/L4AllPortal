/*
* ATTENZIONE! 
    -QUESTO SCRIPT NON FUNZIONAVA: L'HO DOVUTO MODIFICARE IN ALCUNI PUNTI.
    -Fa uso della funzione .trim(), quindi potrebbe dare problemi con IE!!!
  ...
  function deserializeArray(node) {
    ...
    while ((child = node.firstChild) != null) {
      ...
      if(isSimpleVar(nodeType)) {
        ...
        if((child.textContent.trim() != '')) { //hack per sistemare gli array!
